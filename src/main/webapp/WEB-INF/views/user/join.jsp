...
<body class="text-center">
	...
	<main class="form-signin w-100 m-auto">
		<form method="POST" action="/user/join" onsubmit="return validation()">
			...
			<div class="form-floating">
				<input type="password" class="form-control normal" id="uiPwd"
					name="uiPwd" placeholder="비밀번호"> <label for="uiPwd">비밀번호</label>
			</div>
			<div class="form-floating">
				<input type="text" class="form-control normal" id="uiName"
					name="uiName" placeholder="이름"> <label for="uiName">이름</label>
			</div>
			<div class="form-floating">
